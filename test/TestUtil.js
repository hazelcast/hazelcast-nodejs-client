...
exports.closeTwoMembersOutOfThreeAndTestListener = async function (
    cluster, testFactory, done, isSmart, membersToClose, turnoffMember
) {
    ...
    try {
        ...
        await exports.promiseWaitMilliseconds(8000);
