...
describe('Portable Serialization', function() {
    ...
    function PortableObject(a_byte, a_boolean, a_character, a_short, an_integer, a_long, a_float, a_double, a_string, bytes, booleans, chars, shorts, integers, longs, floats, doubles, strings) {
        this.a_byte = a_byte;
