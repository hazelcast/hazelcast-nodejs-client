...
As an example use case, you can use unisocket client in FaaS use cases. Let's say you are starting Hazelcast Node.js Client for
each invocation of the function. In this case, using unisocket client will be faster because the client will connect to just one
member.
