#!/bin/sh
HZ_VERSION="3.12.10-SNAPSHOT"
HAZELCAST_TEST_VERSION="3.12.10-SNAPSHOT"
...
if [ -n "${HAZELCAST_ENTERPRISE_KEY}" ]; then
    ...
    CLASSPATH="hazelcast-remote-controller-${HAZELCAST_RC_VERSION}.jar:hazelcast-enterprise-${HAZELCAST_VERSION}.jar:hazelcast-enterprise-${HAZELCAST_TEST_VERSION}-tests.jar:hazelcast-${HAZELCAST_VERSION}.jar:hazelcast-${HAZELCAST_TEST_VERSION}-tests.jar:test/javaclasses"
