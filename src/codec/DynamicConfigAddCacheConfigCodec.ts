...
export class DynamicConfigAddCacheConfigCodec {
    ...
    static encodeRequest(name: string, keyType: string, valueType: string, statisticsEnabled: boolean, managementEnabled: boolean, readThrough: boolean, writeThrough: boolean, cacheLoaderFactory: string, cacheWriterFactory: string, cacheLoader: string, cacheWriter: string, backupCount: number, asyncBackupCount: number, inMemoryFormat: string, quorumName: string, mergePolicy: string, disablePerEntryInvalidationEvents: boolean, partitionLostListenerConfigs: Array<ListenerConfigHolder>, expiryPolicyFactoryClassName: string, timedExpiryPolicyFactoryConfig: TimedExpiryPolicyFactoryConfig, cacheEntryListeners: Array<CacheSimpleEntryListenerConfig>, evictionConfig: EvictionConfigHolder, wanReplicationRef: WanReplicationRef, eventJournalConfig: EventJournalConfig, hotRestartConfig: HotRestartConfig) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(DynamicConfigAddCacheConfigCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(DynamicConfigAddCacheConfigCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
