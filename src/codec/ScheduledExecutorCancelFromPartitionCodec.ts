...
var REQUEST_TYPE = ScheduledExecutorMessageType.SCHEDULEDEXECUTOR_CANCELFROMPARTITION;
...
export class ScheduledExecutorCancelFromPartitionCodec {
    ...
    static calculateSize(schedulerName: string, taskName: string, mayInterruptIfRunning: boolean) {
...
// Encode request into clientMessage
        var clientMessage = ClientMessage.newClientMessage(this.calculateSize(schedulerName, taskName, mayInterruptIfRunning));
