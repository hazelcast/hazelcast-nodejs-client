...
export class TransactionalMapContainsKeyCodec {
    ...
    static encodeRequest(name: string, txnId: string, threadId: Long, key: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(TransactionalMapContainsKeyCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(TransactionalMapContainsKeyCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
