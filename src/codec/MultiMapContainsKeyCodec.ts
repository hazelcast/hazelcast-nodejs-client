...
export class MultiMapContainsKeyCodec {
    ...
    static encodeRequest(name: string, key: Data, threadId: Long) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MultiMapContainsKeyCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MultiMapContainsKeyCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
