...
export class TransactionalListAddCodec {
    ...
    static encodeRequest(name: string, txnId: string, threadId: Long, item: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(TransactionalListAddCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(TransactionalListAddCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
