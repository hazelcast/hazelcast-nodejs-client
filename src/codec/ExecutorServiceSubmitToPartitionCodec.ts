...
export class ExecutorServiceSubmitToPartitionCodec {
    ...
    static calculateSize(name: string, uuid: string, callable: Data, partitionId: number) {
// Calculates the request payload size
    ...
    static encodeRequest(name: string, uuid: string, callable: Data, partitionId: number) {
// Encode request into clientMessage
        var clientMessage = ClientMessage.newClientMessage(this.calculateSize(name, uuid, callable, partitionId));
