...
export class ClientCreateProxyCodec {
    ...
    static encodeRequest(name: string, serviceName: string, target: Address) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ClientCreateProxyCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ClientCreateProxyCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
