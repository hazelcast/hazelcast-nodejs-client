...
// hex: 0x0E0800
const REQUEST_MESSAGE_TYPE = 919552;
// hex: 0x0E0801
// RESPONSE_MESSAGE_TYPE = 919553
...
export interface TransactionalMapPutIfAbsentResponseParams {
    response: Data;
}
...
export class TransactionalMapPutIfAbsentCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalMapPutIfAbsentResponseParams {
        ...
        const response = {} as TransactionalMapPutIfAbsentResponseParams;
