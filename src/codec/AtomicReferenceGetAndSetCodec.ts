...
export class AtomicReferenceGetAndSetCodec {
    ...
    static encodeRequest(name: string, newValue: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(AtomicReferenceGetAndSetCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(AtomicReferenceGetAndSetCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
