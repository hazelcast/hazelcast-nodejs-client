...
export class CPSessionCreateSessionCodec {
    ...
    static encodeRequest(groupId: RaftGroupId, endpointName: string) {
        var clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(true);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName("CPSession.CreateSession");
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CPSessionCreateSessionCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(sessionId: Long , ttlMillis: Long , heartbeatMillis: Long ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CPSessionCreateSessionCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
