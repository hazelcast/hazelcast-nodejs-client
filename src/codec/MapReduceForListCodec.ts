...
var REQUEST_TYPE = MapReduceMessageType.MAPREDUCE_FORLIST;
var RESPONSE_TYPE = 117;
var RETRYABLE = false;


export class MapReduceForListCodec {


    static calculateSize(name: string, jobId: string, predicate: Data, mapper: Data, combinerFactory: Data, reducerFactory: Data, listName: string, chunkSize: number, keys: any, topologyChangedStrategy: string) {
// Calculates the request payload size
        ...
        dataSize += BitsUtil.calculateSizeString(listName);
    ...
    static encodeRequest(name: string, jobId: string, predicate: Data, mapper: Data, combinerFactory: Data, reducerFactory: Data, listName: string, chunkSize: number, keys: any, topologyChangedStrategy: string) {
// Encode request into clientMessage
        var clientMessage = ClientMessage.newClientMessage(this.calculateSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, listName, chunkSize, keys, topologyChangedStrategy));
        ...
        clientMessage.appendString(listName);
