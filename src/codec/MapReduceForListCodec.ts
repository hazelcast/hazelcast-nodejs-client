...
static calculateSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, listName, chunkSize, keys, topologyChangedStrategy){
    ...
    dataSize += BitsUtil.calculateSizeStr(listName);
...
static encodeRequest(name, jobId, predicate, mapper, combinerFactory, reducerFactory, listName, chunkSize, keys, topologyChangedStrategy){
    // Encode request into clientMessage
    var payloadSize;
    var clientMessage = new ClientMessage(payloadSize=this.calculateSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, listName, chunkSize, keys, topologyChangedStrategy));
    ...
    clientMessage.appendStr(listName);
