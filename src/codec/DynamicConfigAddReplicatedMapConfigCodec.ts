...
export class DynamicConfigAddReplicatedMapConfigCodec {
    ...
    static encodeRequest(name: string, inMemoryFormat: string, asyncFillup: boolean, statisticsEnabled: boolean, mergePolicy: string, listenerConfigs: Array<ListenerConfigHolder>, quorumName: string, mergeBatchSize: number) {
        var clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(false);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName("DynamicConfig.AddReplicatedMapConfig");
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(DynamicConfigAddReplicatedMapConfigCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(DynamicConfigAddReplicatedMapConfigCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
