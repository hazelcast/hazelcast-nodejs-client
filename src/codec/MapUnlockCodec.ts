...
export class MapUnlockCodec {
    ...
    static encodeRequest(name: string, key: Data, threadId: Long, referenceId: Long) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MapUnlockCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MapUnlockCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
