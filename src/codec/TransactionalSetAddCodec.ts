...
export class TransactionalSetAddCodec {
    ...
    static encodeRequest(name: string, txnId: string, threadId: Long, item: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(TransactionalSetAddCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(TransactionalSetAddCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
