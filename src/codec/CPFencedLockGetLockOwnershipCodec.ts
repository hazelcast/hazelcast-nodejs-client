...
export class CPFencedLockGetLockOwnershipCodec {
    ...
    static encodeRequest(groupId: RaftGroupId, name: string) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CPFencedLockGetLockOwnershipCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(fence: Long , lockCount: number , sessionId: Long , threadId: Long ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CPFencedLockGetLockOwnershipCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
