...
export class MapAddNearCacheInvalidationListenerCodec {
    ...
    static handle(clientMessage: ClientMessage, handleIMapInvalidationEvent: ((key: Data | null, sourceUuid: UUID, partitionUuid: UUID, sequence: Long) => void) | null = null, handleIMapBatchInvalidationEvent: ((keys: Data[], sourceUuids: UUID[], partitionUuids: UUID[], sequences: Long[]) => void) | null = null): void {
