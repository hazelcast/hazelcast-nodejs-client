...
export class ScheduledExecutorGetResultFromAddressCodec {
    ...
    static encodeRequest(schedulerName: string, taskName: string, address: Address) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ScheduledExecutorGetResultFromAddressCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ScheduledExecutorGetResultFromAddressCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
