...
export class QueueDrainToMaxSizeCodec {
    ...
    static encodeRequest(name: string, maxSize: number) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(QueueDrainToMaxSizeCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Array<Data> ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(QueueDrainToMaxSizeCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
