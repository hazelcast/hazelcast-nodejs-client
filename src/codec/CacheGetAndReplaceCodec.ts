...
export class CacheGetAndReplaceCodec {
    ...
    static encodeRequest(name: string, key: Data, value: Data, expiryPolicy: Data, completionId: number) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CacheGetAndReplaceCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CacheGetAndReplaceCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
