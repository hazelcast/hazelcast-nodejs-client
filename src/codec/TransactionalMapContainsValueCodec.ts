...
// hex: 0x0E1200
const REQUEST_MESSAGE_TYPE = 922112;
// hex: 0x0E1201
// RESPONSE_MESSAGE_TYPE = 922113
...
export interface TransactionalMapContainsValueResponseParams {
    response: boolean;
}

export class TransactionalMapContainsValueCodec {
    static encodeRequest(name: string, txnId: UUID, threadId: Long, value: Data): ClientMessage {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalMapContainsValueResponseParams {
        const initialFrame = clientMessage.nextFrame();

        const response = {} as TransactionalMapContainsValueResponseParams;
