...
/** @internal */
export interface MapDeleteResponseParams {
    response: boolean;
...
export class MapDeleteCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): MapDeleteResponseParams {
        const initialFrame = clientMessage.nextFrame();

        const response = {} as MapDeleteResponseParams;
        if (initialFrame.content.length >= RESPONSE_RESPONSE_OFFSET + BitsUtil.BOOLEAN_SIZE_IN_BYTES) {
