...
export class DynamicConfigAddAtomicReferenceConfigCodec {
    ...
    static encodeRequest(name: string, splitBrainProtectionName: string, mergePolicy: string, mergeBatchSize: number): ClientMessage {
        ...
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(DynamicConfigAddAtomicReferenceConfigCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage: ClientMessage): RequestParameters {
     ...
     static encodeResponse(): ClientMessage {
        const clientMessage = ClientMessage.createForEncode();
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(DynamicConfigAddAtomicReferenceConfigCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
