...
export class MapReduceForMultiMapCodec {
    ...
    static calculateSize(name: string, jobId: string, predicate: Data, mapper: Data, combinerFactory: Data, reducerFactory: Data, multiMapName: string, chunkSize: number, keys: any, topologyChangedStrategy: string) {
// Calculates the request payload size
        ...
        dataSize += BitsUtil.calculateSizeString(multiMapName);
    ...
    static encodeRequest(name: string, jobId: string, predicate: Data, mapper: Data, combinerFactory: Data, reducerFactory: Data, multiMapName: string, chunkSize: number, keys: any, topologyChangedStrategy: string) {
// Encode request into clientMessage
        var clientMessage = ClientMessage.newClientMessage(this.calculateSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, multiMapName, chunkSize, keys, topologyChangedStrategy));
        ...
        clientMessage.appendString(multiMapName);
