...
export class PNCounterGetCodec {
    ...
    static encodeRequest(name: string, replicaTimestamps: Array<[string, Long]>, targetReplica: Address) {
        var clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(true);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName("PNCounter.Get");
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(PNCounterGetCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(value: Long , replicaTimestamps: Array<[string, Long]> , replicaCount: number ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(PNCounterGetCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
