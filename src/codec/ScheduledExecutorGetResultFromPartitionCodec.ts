...
export class ScheduledExecutorGetResultFromPartitionCodec {
    ...
    static encodeRequest(schedulerName: string, taskName: string) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ScheduledExecutorGetResultFromPartitionCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ScheduledExecutorGetResultFromPartitionCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
