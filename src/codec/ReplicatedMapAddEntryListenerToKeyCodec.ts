...
const REQUEST_TYPE = ReplicatedMapMessageType.REPLICATEDMAP_ADDENTRYLISTENERTOKEY;
...
export class ReplicatedMapAddEntryListenerToKeyCodec {
    ...
    static calculateSize(name: string, key: Data, localOnly: boolean) {
...
// Encode request into clientMessage
        const clientMessage = ClientMessage.newClientMessage(this.calculateSize(name, key, localOnly));
