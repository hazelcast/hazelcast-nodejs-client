...
export class MapAddEntryListenerToKeyCodec {
    ...
    static handle(clientMessage: ClientMessage, handleEntryEvent: ((key: Data | null, value: Data | null, oldValue: Data | null, mergingValue: Data | null, eventType: number, uuid: UUID, numberOfAffectedEntries: number) => void) | null = null): void {
