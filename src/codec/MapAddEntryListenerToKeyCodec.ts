...
static calculateSize(name, key, includeValue, listenerFlags, localOnly){
...
static encodeRequest(name, key, includeValue, listenerFlags, localOnly){
    ...
    var payloadSize;
    var clientMessage = new ClientMessage(payloadSize=this.calculateSize(name, key, includeValue, listenerFlags, localOnly));
