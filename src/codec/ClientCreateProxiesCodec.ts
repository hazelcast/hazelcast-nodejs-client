...
export class ClientCreateProxiesCodec {
    ...
    static encodeRequest(proxies: Array<[string, string]>): ClientMessage {
        ...
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(ClientCreateProxiesCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage: ClientMessage): RequestParameters {
     ...
     static encodeResponse(): ClientMessage {
        const clientMessage = ClientMessage.createForEncode();
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(ClientCreateProxiesCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
