...
// hex: 0x120200
const REQUEST_MESSAGE_TYPE = 1180160;
// hex: 0x120201
// RESPONSE_MESSAGE_TYPE = 1180161
...
export interface TransactionalQueueTakeResponseParams {
    response: Data;
}
...
export class TransactionalQueueTakeCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalQueueTakeResponseParams {
        ...
        const response = {} as TransactionalQueueTakeResponseParams;
