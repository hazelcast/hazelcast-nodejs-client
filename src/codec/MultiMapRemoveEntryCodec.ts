...
export class MultiMapRemoveEntryCodec {
    ...
    static encodeRequest(name: string, key: Data, value: Data, threadId: Long): ClientMessage {
        ...
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(MultiMapRemoveEntryCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage: ClientMessage): RequestParameters {
     ...
     static encodeResponse(response: boolean ): ClientMessage {
        const clientMessage = ClientMessage.createForEncode();
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(MultiMapRemoveEntryCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
