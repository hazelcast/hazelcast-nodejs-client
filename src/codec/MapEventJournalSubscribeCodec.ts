...
export class MapEventJournalSubscribeCodec {
    ...
    static encodeRequest(name: string) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MapEventJournalSubscribeCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(oldestSequence: Long , newestSequence: Long ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MapEventJournalSubscribeCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
