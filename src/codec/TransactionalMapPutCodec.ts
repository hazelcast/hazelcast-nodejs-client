...
export class TransactionalMapPutCodec {
    ...
    static calculateSize(name: string, txnId: string, threadId: any, key: Data, value: Data, ttl: any) {
// Calculates the request payload size
    ...
    static encodeRequest(name: string, txnId: string, threadId: any, key: Data, value: Data, ttl: any) {
// Encode request into clientMessage
        var clientMessage = ClientMessage.newClientMessage(this.calculateSize(name, txnId, threadId, key, value, ttl));
