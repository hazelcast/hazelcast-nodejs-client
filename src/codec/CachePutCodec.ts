...
export class CachePutCodec {
    ...
    static encodeRequest(name: string, key: Data, value: Data, expiryPolicy: Data, get: boolean, completionId: number) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CachePutCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CachePutCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
