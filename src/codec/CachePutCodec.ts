...
static calculateSize(name, key, value, expiryPolicy, get, completionId){
...
static encodeRequest(name, key, value, expiryPolicy, get, completionId){
    // Encode request into clientMessage
    var payloadSize;
    var clientMessage = new ClientMessage(payloadSize=this.calculateSize(name, key, value, expiryPolicy, get, completionId));
