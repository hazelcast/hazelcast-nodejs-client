...
/** @internal */
export interface AtomicRefCompareAndSetResponseParams {
    response: boolean;
}
...
export class AtomicRefCompareAndSetCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): AtomicRefCompareAndSetResponseParams {
        const initialFrame = clientMessage.nextFrame();

        const response = {} as AtomicRefCompareAndSetResponseParams;
