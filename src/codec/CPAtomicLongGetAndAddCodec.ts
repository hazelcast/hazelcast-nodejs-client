...
export class CPAtomicLongGetAndAddCodec {
    ...
    static encodeRequest(groupId: RaftGroupId, name: string, delta: Long) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CPAtomicLongGetAndAddCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Long ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CPAtomicLongGetAndAddCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
