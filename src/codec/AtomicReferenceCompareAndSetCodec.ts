...
export class AtomicReferenceCompareAndSetCodec {
    ...
    static encodeRequest(name: string, expected: Data, updated: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(AtomicReferenceCompareAndSetCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(AtomicReferenceCompareAndSetCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
