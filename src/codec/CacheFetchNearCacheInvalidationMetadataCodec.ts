...
export class CacheFetchNearCacheInvalidationMetadataCodec {
    ...
    static encodeRequest(names: Array<string>, address: Address) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CacheFetchNearCacheInvalidationMetadataCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(namePartitionSequenceList: Array<[string, Array<[number,Long]>]> , partitionUuidList: Array<[number, UUID]> ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CacheFetchNearCacheInvalidationMetadataCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
