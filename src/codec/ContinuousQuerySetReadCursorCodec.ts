...
var REQUEST_TYPE = ContinuousQueryMessageType.CONTINUOUSQUERY_SETREADCURSOR;
...
export class ContinuousQuerySetReadCursorCodec {
    ...
    static calculateSize(mapName: string, cacheName: string, sequence: any) {
// Calculates the request payload size
    ...
    static encodeRequest(mapName: string, cacheName: string, sequence: any) {
// Encode request into clientMessage
        var clientMessage = ClientMessage.newClientMessage(this.calculateSize(mapName, cacheName, sequence));
