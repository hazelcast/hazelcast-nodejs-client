...
export class DynamicConfigAddTopicConfigCodec {
    ...
    static encodeRequest(name: string, globalOrderingEnabled: boolean, statisticsEnabled: boolean, multiThreadingEnabled: boolean, listenerConfigs: Array<ListenerConfigHolder>): ClientMessage {
        const clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(false);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName('DynamicConfig.AddTopicConfig');
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(DynamicConfigAddTopicConfigCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage: ClientMessage): RequestParameters {
     ...
     static encodeResponse(): ClientMessage {
        const clientMessage = ClientMessage.createForEncode();
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(DynamicConfigAddTopicConfigCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
