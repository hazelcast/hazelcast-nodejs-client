...
export class ScheduledExecutorDisposeFromAddressCodec {
    ...
    static encodeRequest(schedulerName: string, taskName: string, address: Address) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ScheduledExecutorDisposeFromAddressCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ScheduledExecutorDisposeFromAddressCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
