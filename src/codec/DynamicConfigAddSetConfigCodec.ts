...
export class DynamicConfigAddSetConfigCodec {
    ...
    static encodeRequest(name: string, listenerConfigs: Array<ListenerConfigHolder>, backupCount: number, asyncBackupCount: number, maxSize: number, statisticsEnabled: boolean, quorumName: string, mergePolicy: string, mergeBatchSize: number) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(DynamicConfigAddSetConfigCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(DynamicConfigAddSetConfigCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
