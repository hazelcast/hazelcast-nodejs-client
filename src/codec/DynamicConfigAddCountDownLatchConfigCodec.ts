...
export class DynamicConfigAddCountDownLatchConfigCodec {
    ...
    static encodeRequest(name: string, quorumName: string) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(DynamicConfigAddCountDownLatchConfigCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(DynamicConfigAddCountDownLatchConfigCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
