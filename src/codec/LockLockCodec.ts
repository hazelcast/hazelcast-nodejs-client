...
export class LockLockCodec {
    ...
    private static REQUEST_REFERENCE_ID_FIELD_OFFSET = LockLockCodec.REQUEST_THREAD_ID_FIELD_OFFSET + FixedSizeTypes.LONG_SIZE_IN_BYTES;
    ...
    static encodeRequest(name: string, leaseTime: Long, threadId: Long, referenceId: Long): ClientMessage {
        ...
        FixedSizeTypes.encodeLong(initialFrame.content, LockLockCodec.REQUEST_REFERENCE_ID_FIELD_OFFSET, referenceId);
