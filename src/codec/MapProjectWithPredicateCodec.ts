...
export class MapProjectWithPredicateCodec {
    ...
    static encodeRequest(name: string, projection: Data, predicate: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MapProjectWithPredicateCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Array<Data> ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MapProjectWithPredicateCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
