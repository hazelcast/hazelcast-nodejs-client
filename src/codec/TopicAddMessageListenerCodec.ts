 ...
 *
 * @generated Hazelcast Client Protocol Code Generator @dbdb336
...
export class TopicAddMessageListenerCodec {
    ...
    static handle(clientMessage: ClientMessage, handleTopicEvent: ((item: Data, publishTime: Long, uuid: UUID) => void) | null = null): void {
