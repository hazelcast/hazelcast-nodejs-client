...
export class CacheManagementConfigCodec {
    ...
    static encodeRequest(name: string, isStat: boolean, enabled: boolean, address: Address) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CacheManagementConfigCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CacheManagementConfigCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
