...
export class MapSubmitToKeyCodec {
    ...
    static encodeRequest(name: string, entryProcessor: Data, key: Data, threadId: Long) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MapSubmitToKeyCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MapSubmitToKeyCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
