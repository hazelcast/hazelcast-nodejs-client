...
export class CacheSetExpiryPolicyCodec {
    ...
    static encodeRequest(name: string, keys: Array<Data>, expiryPolicy: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CacheSetExpiryPolicyCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CacheSetExpiryPolicyCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
