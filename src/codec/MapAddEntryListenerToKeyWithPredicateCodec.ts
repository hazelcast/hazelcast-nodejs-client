...
static calculateSize(name, key, predicate, includeValue, listenerFlags, localOnly){
...
static encodeRequest(name, key, predicate, includeValue, listenerFlags, localOnly){
    ...
    var payloadSize;
    var clientMessage = new ClientMessage(payloadSize=this.calculateSize(name, key, predicate, includeValue, listenerFlags, localOnly));
