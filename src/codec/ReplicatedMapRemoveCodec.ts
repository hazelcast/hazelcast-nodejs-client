...
export class ReplicatedMapRemoveCodec {
    ...
    static encodeRequest(name: string, key: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ReplicatedMapRemoveCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ReplicatedMapRemoveCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
