...
// hex: 0x0E0B00
const REQUEST_MESSAGE_TYPE = 920320;
// hex: 0x0E0B01
// RESPONSE_MESSAGE_TYPE = 920321
...
export interface TransactionalMapRemoveResponseParams {
    response: Data;
}
...
export class TransactionalMapRemoveCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalMapRemoveResponseParams {
        ...
        const response = {} as TransactionalMapRemoveResponseParams;
