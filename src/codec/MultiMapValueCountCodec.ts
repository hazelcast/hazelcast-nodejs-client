...
export class MultiMapValueCountCodec {
    ...
    static encodeRequest(name: string, key: Data, threadId: Long) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MultiMapValueCountCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: number ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MultiMapValueCountCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
