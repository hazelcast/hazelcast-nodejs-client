...
export class CacheReplaceCodec {
    ...
    static encodeRequest(name: string, key: Data, oldValue: Data, newValue: Data, expiryPolicy: Data, completionId: number) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CacheReplaceCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CacheReplaceCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
