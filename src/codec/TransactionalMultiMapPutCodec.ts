...
// hex: 0x0F0100
const REQUEST_MESSAGE_TYPE = 983296;
// hex: 0x0F0101
// RESPONSE_MESSAGE_TYPE = 983297
...
export interface TransactionalMultiMapPutResponseParams {
    response: boolean;
}

export class TransactionalMultiMapPutCodec {
    static encodeRequest(name: string, txnId: UUID, threadId: Long, key: Data, value: Data): ClientMessage {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalMultiMapPutResponseParams {
        const initialFrame = clientMessage.nextFrame();

        const response = {} as TransactionalMultiMapPutResponseParams;
