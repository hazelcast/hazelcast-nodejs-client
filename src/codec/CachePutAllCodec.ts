...
export class CachePutAllCodec {
    ...
    static encodeRequest(name: string, entries: Array<[Data, Data]>, expiryPolicy: Data, completionId: number): ClientMessage {
        ...
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(CachePutAllCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage: ClientMessage): RequestParameters {
     ...
     static encodeResponse(): ClientMessage {
        const clientMessage = ClientMessage.createForEncode();
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(CachePutAllCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
