...
// hex: 0x0F0300
const REQUEST_MESSAGE_TYPE = 983808;
// hex: 0x0F0301
// RESPONSE_MESSAGE_TYPE = 983809
...
export interface TransactionalMultiMapRemoveResponseParams {
    response: Data[];
}
...
export class TransactionalMultiMapRemoveCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalMultiMapRemoveResponseParams {
        ...
        const response = {} as TransactionalMultiMapRemoveResponseParams;
