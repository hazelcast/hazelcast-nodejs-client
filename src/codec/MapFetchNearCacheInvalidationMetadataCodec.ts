...
export class MapFetchNearCacheInvalidationMetadataCodec {
    ...
    static encodeRequest(names: Array<string>, address: Address): ClientMessage {
        ...
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(MapFetchNearCacheInvalidationMetadataCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage: ClientMessage): RequestParameters {
     ...
     static encodeResponse(namePartitionSequenceList: Array<[string, Array<[number, Long]>]> , partitionUuidList: Array<[number, UUID]> ): ClientMessage {
        const clientMessage = ClientMessage.createForEncode();
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(MapFetchNearCacheInvalidationMetadataCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
