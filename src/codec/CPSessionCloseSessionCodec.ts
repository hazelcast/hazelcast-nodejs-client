...
export class CPSessionCloseSessionCodec {
    ...
    static encodeRequest(groupId: RaftGroupId, sessionId: Long) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CPSessionCloseSessionCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CPSessionCloseSessionCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
