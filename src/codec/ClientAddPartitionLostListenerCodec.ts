...
export class ClientAddPartitionLostListenerCodec {
    ...
    static EVENT_PARTITION_LOST_PARTITION_ID_FIELD_OFFSET = ClientMessage.PARTITION_ID_FIELD_OFFSET + FixedSizeTypes.INT_SIZE_IN_BYTES;
    static EVENT_PARTITION_LOST_LOST_BACKUP_COUNT_FIELD_OFFSET = ClientAddPartitionLostListenerCodec.EVENT_PARTITION_LOST_PARTITION_ID_FIELD_OFFSET + FixedSizeTypes.INT_SIZE_IN_BYTES;
    static EVENT_PARTITION_LOST_INITIAL_FRAME_SIZE = ClientAddPartitionLostListenerCodec.EVENT_PARTITION_LOST_LOST_BACKUP_COUNT_FIELD_OFFSET + FixedSizeTypes.INT_SIZE_IN_BYTES;
    //hex: 0x000A02
    static EVENT_PARTITION_LOST_MESSAGE_TYPE = 2562;
    ...
    static encodeRequest(localOnly: boolean) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ClientAddPartitionLostListenerCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: string ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ClientAddPartitionLostListenerCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
     ...
     static encodePartitionLostEvent( partitionId : number,  lostBackupCount : number,  source : Address) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ClientAddPartitionLostListenerCodec.EVENT_PARTITION_LOST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
