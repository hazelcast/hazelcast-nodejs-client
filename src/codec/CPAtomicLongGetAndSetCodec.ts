...
export class CPAtomicLongGetAndSetCodec {
    ...
    private CPAtomicLongGetAndSetCodec() {
    }


    static encodeRequest(groupId: RaftGroupId, name: string, newValue: Long) {
        var clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(false);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName("CPAtomicLong.GetAndSet");
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CPAtomicLongGetAndSetCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Long ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CPAtomicLongGetAndSetCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
