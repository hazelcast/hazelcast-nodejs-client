...
static calculateSize(name, predicate, includeValue, listenerFlags, localOnly){
...
static encodeRequest(name, predicate, includeValue, listenerFlags, localOnly){
    ...
    var payloadSize;
    var clientMessage = new ClientMessage(payloadSize=this.calculateSize(name, predicate, includeValue, listenerFlags, localOnly));
