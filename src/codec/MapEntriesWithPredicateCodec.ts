...
export class MapEntriesWithPredicateCodec {
    ...
    static encodeRequest(name: string, predicate: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MapEntriesWithPredicateCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Array<[Data,Data]> ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MapEntriesWithPredicateCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
