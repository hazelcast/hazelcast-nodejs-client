...
export class MapKeySetWithPagingPredicateCodec {
    ...
    static encodeRequest(name: string, predicate: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MapKeySetWithPagingPredicateCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Array<Data> ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MapKeySetWithPagingPredicateCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
