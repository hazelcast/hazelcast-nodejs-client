...
export class ReplicatedMapPutAllCodec {
    ...
    static encodeRequest(name: string, entries: Array<[Data,Data]>): ClientMessage {
        ...
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(ReplicatedMapPutAllCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage: ClientMessage): RequestParameters {
     ...
     static encodeResponse(): ClientMessage {
        const clientMessage = ClientMessage.createForEncode();
        const initialFrame: Frame = new Frame(Buffer.allocUnsafe(ReplicatedMapPutAllCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
