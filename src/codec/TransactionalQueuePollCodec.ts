...
export class TransactionalQueuePollCodec {
    ...
    static encodeRequest(name: string, txnId: string, threadId: Long, timeout: Long) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(TransactionalQueuePollCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(TransactionalQueuePollCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
