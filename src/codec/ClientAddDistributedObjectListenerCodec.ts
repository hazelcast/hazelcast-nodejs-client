...
export class ClientAddDistributedObjectListenerCodec {
    ...
    static handle(clientMessage: ClientMessage, handleDistributedObjectEvent: ((name: string, serviceName: string, eventType: string, source: UUID) => void) | null = null): void {
