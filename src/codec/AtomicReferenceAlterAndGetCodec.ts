...
export class AtomicReferenceAlterAndGetCodec {
    ...
    private AtomicReferenceAlterAndGetCodec() {
    }
    ...
    static encodeRequest(name: string, functionX: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(AtomicReferenceAlterAndGetCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(AtomicReferenceAlterAndGetCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
