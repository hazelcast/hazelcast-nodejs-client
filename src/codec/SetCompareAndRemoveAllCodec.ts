...
export class SetCompareAndRemoveAllCodec {
    ...
    static encodeRequest(name: string, values: Array<Data>) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(SetCompareAndRemoveAllCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(SetCompareAndRemoveAllCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
