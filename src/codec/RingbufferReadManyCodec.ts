...
export class RingbufferReadManyCodec {
    ...
    static encodeRequest(name: string, startSequence: Long, minCount: number, maxCount: number, filter: Data) {
        var clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(true);
        clientMessage.setAcquiresResource(false);
        clientMessage.setOperationName("Ringbuffer.ReadMany");
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(RingbufferReadManyCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(readCount: number , items: Array<Data> , itemSeqs: Array<Long> , nextSeq: Long ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(RingbufferReadManyCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
