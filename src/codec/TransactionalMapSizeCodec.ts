...
// hex: 0x0E0400
const REQUEST_MESSAGE_TYPE = 918528;
// hex: 0x0E0401
// RESPONSE_MESSAGE_TYPE = 918529
...
export interface TransactionalMapSizeResponseParams {
    response: number;
}
...
export class TransactionalMapSizeCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalMapSizeResponseParams {
        ...
        const response = {} as TransactionalMapSizeResponseParams;
