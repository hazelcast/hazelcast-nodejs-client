...
export class MapAggregateWithPredicateCodec {
    ...
    static encodeRequest(name: string, aggregator: Data, predicate: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MapAggregateWithPredicateCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MapAggregateWithPredicateCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
