...
export class MapPutAllCodec {
    //hex: 0x013000
    public static REQUEST_MESSAGE_TYPE = 77824;
    //hex: 0x013001
    public static RESPONSE_MESSAGE_TYPE = 77825;
    ...
    static encodeRequest(name: string, entries: Array<[Data,Data]>) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(MapPutAllCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
        FixedSizeTypes.encodeInt(initialFrame.content, ClientMessage.TYPE_FIELD_OFFSET, MapPutAllCodec.REQUEST_MESSAGE_TYPE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(MapPutAllCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
        FixedSizeTypes.encodeInt(initialFrame.content, ClientMessage.TYPE_FIELD_OFFSET, MapPutAllCodec.RESPONSE_MESSAGE_TYPE);
        clientMessage.add(initialFrame);
