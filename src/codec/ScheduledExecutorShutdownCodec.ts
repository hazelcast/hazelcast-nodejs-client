...
export class ScheduledExecutorShutdownCodec {
    ...
    static encodeRequest(schedulerName: string, address: Address) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ScheduledExecutorShutdownCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ScheduledExecutorShutdownCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
