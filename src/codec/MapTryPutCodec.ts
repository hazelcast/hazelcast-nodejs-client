...
export class MapTryPutCodec {
    ...
    static calculateSize(name:string, key:Data, value:Data, threadId:number, timeout:number) {
    ...
    static encodeRequest(name:string, key:Data, value:Data, threadId:number, timeout:number) {
