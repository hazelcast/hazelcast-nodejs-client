...
export class AtomicReferenceContainsCodec {
    ...
    private AtomicReferenceContainsCodec() {
    }
    ...
    static encodeRequest(name: string, expected: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(AtomicReferenceContainsCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(AtomicReferenceContainsCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
