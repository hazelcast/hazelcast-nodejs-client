...
export class TransactionalMapKeySetWithPredicateCodec {
    ...
    static encodeRequest(name: string, txnId: string, threadId: Long, predicate: Data) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(TransactionalMapKeySetWithPredicateCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Array<Data> ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(TransactionalMapKeySetWithPredicateCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
