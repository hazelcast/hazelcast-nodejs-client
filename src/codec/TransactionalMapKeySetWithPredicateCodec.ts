...
// hex: 0x0E0F00
const REQUEST_MESSAGE_TYPE = 921344;
// hex: 0x0E0F01
// RESPONSE_MESSAGE_TYPE = 921345
...
export interface TransactionalMapKeySetWithPredicateResponseParams {
    response: Data[];
}

export class TransactionalMapKeySetWithPredicateCodec {
    static encodeRequest(name: string, txnId: UUID, threadId: Long, predicate: Data): ClientMessage {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalMapKeySetWithPredicateResponseParams {
        // empty initial frame
        clientMessage.nextFrame();

        const response = {} as TransactionalMapKeySetWithPredicateResponseParams;
