...
export class ScheduledExecutorGetStatsFromPartitionCodec {
    ...
    static encodeRequest(schedulerName: string, taskName: string) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ScheduledExecutorGetStatsFromPartitionCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(lastIdleTimeNanos: Long , totalIdleTimeNanos: Long , totalRuns: Long , totalRunTimeNanos: Long , lastRunDurationNanos: Long ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ScheduledExecutorGetStatsFromPartitionCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
