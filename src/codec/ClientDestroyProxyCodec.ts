...
export class ClientDestroyProxyCodec {
    ...
    static encodeRequest(name: string, serviceName: string) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(ClientDestroyProxyCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(ClientDestroyProxyCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
