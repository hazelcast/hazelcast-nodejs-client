...
export class DurableExecutorRetrieveResultCodec {
    ...
    static encodeRequest(name: string, sequence: number) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(DurableExecutorRetrieveResultCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: Data ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(DurableExecutorRetrieveResultCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
