...
var REQUEST_TYPE = MapReduceMessageType.MAPREDUCE_FORMAP;
var RESPONSE_TYPE = 117;
var RETRYABLE = false;


export class MapReduceForMapCodec {


    static calculateSize(name: string, jobId: string, predicate: Data, mapper: Data, combinerFactory: Data, reducerFactory: Data, mapName: string, chunkSize: number, keys: any, topologyChangedStrategy: string) {
// Calculates the request payload size
    ...
    static encodeRequest(name: string, jobId: string, predicate: Data, mapper: Data, combinerFactory: Data, reducerFactory: Data, mapName: string, chunkSize: number, keys: any, topologyChangedStrategy: string) {
// Encode request into clientMessage
        var clientMessage = ClientMessage.newClientMessage(this.calculateSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, mapName, chunkSize, keys, topologyChangedStrategy));
