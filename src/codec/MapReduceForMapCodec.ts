...
static calculateSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, mapName, chunkSize, keys, topologyChangedStrategy){
...
static encodeRequest(name, jobId, predicate, mapper, combinerFactory, reducerFactory, mapName, chunkSize, keys, topologyChangedStrategy){
    // Encode request into clientMessage
    var payloadSize;
    var clientMessage = new ClientMessage(payloadSize=this.calculateSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, mapName, chunkSize, keys, topologyChangedStrategy));
