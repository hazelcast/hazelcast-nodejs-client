...
// hex: 0x0E0200
const REQUEST_MESSAGE_TYPE = 918016;
// hex: 0x0E0201
// RESPONSE_MESSAGE_TYPE = 918017
...
export interface TransactionalMapGetResponseParams {
    response: Data;
}
...
export class TransactionalMapGetCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalMapGetResponseParams {
        // empty initial frame
        clientMessage.nextFrame();

        const response = {} as TransactionalMapGetResponseParams;
