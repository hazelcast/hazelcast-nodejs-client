...
export class CountDownLatchTrySetCountCodec {
    ...
    static encodeRequest(name: string, count: number) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CountDownLatchTrySetCountCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse(response: boolean ) {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CountDownLatchTrySetCountCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
