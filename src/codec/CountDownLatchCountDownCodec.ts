...
export class CountDownLatchCountDownCodec {
    ...
    static encodeRequest(name: string) {
        ...
        var initialFrame : Frame= new Frame(Buffer.allocUnsafe(CountDownLatchCountDownCodec.REQUEST_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
    ...
    static decodeRequest(clientMessage : ClientMessage) {
     ...
     static encodeResponse() {
        var clientMessage = ClientMessage.createForEncode();
        var initialFrame : Frame = new Frame(Buffer.allocUnsafe(CountDownLatchCountDownCodec.RESPONSE_INITIAL_FRAME_SIZE), ClientMessage.UNFRAGMENTED_MESSAGE);
