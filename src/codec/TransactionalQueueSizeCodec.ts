...
// hex: 0x120500
const REQUEST_MESSAGE_TYPE = 1180928;
// hex: 0x120501
// RESPONSE_MESSAGE_TYPE = 1180929
...
export interface TransactionalQueueSizeResponseParams {
    response: number;
}
...
export class TransactionalQueueSizeCodec {
    ...
    static decodeResponse(clientMessage: ClientMessage): TransactionalQueueSizeResponseParams {
        const initialFrame = clientMessage.nextFrame();

        const response = {} as TransactionalQueueSizeResponseParams;
