...
Client.newHazelcastClient().then(function (hz) {
    hz.getQueue('item-listener-queue').then(function (s) {
        var queue = s;
        return queue.clear().then(function () {
            return queue.addItemListener(itemListener, true);
        }).then(function () {
                return queue.add('Item1');
            }).then(function () {
                return queue.add('Item2');
            }).then(function () {
                return queue.add('Item3');
            }).then(function () {
                return queue.add('Item4');
            }).then(function () {
                return queue.remove('Item1');
            }).then(function () {
                return queue.remove('Item2');
            }).then(function () {
